...
function landing2ShowRegister () {
  ...
  $( "#landing2Login" ).hide();
  $( "#landing2AcceptWithoutRegistering" ).hide();
}
...
// Add another contact field to the current request form
function landing2ShowRegisterWithoutAccepting () {
  $( "#landing2Login" ).hide();
  $( "#landing2Register" ).hide();
  $( "#landing2AcceptWithoutRegistering" ).show();
}

// Add another contact field to the current request form
function showNameForm (theName, theForm) {
  var displayName = "#" + theName;
  var displayForm = "#" + theForm;
  $( displayName ).hide();
  $( displayForm ).show();
}
