...
// Replaces a list of contacts with a form. Used to allow a user to edit a contact list.
$(".swapForm").click( function (){
  var displayName = "#" + this.id + "Container";
  var displayForm = "#" + this.id + "Form";
  $( displayName ).hide();
  $( displayForm ).show();
  return false; // we don't want the page to refresh on click
});


// Replaces an 'edit contacts' form with a list of contacts. Returns user to the list on 'cancel'.
 
$(".swapText").click( function (){
	var thisId = JSON.stringify(this.id);
	var stringId = this.id.slice(0, -4);
	var displayName = "#" + stringId + "Container";
	var displayForm = "#" + stringId + "Form";
	$( displayName ).show();
 	$( displayForm ).hide();
  return false; // we don't want the page to refresh on click
});
...
/*
$(".swapForm").click({param1: "Hello", param2: "World"}, swapDataWithForm);

// Swap a hardcoded set of fields with a form to edit them
function swapDataWithForm (theName, theForm) {
  var displayName = "#" + theName;
  var displayForm = "#" + theForm;
  $( displayName ).hide();
  $( displayForm ).show();
  return false // we don't want the link to trigger a page load
}
*/
